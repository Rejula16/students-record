    ...
    <div class="space-y-5">
        ...
        <section class="rounded-[28px] border border-white/60 bg-white/92 p-5 shadow-[0_18px_40px_rgba(115,150,196,0.12)] md:p-6 dark:border-slate-700/60 dark:bg-slate-900/85 dark:shadow-[0_18px_40px_rgba(0,0,0,0.35)]">
            <div class="mb-6 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                <div>
                    <p class="text-lg font-semibold text-slate-800 dark:text-slate-100">Student Statistics</p>
                    <p class="mt-1 text-sm text-slate-400 dark:text-slate-400">Clean dashboard view with reusable Laravel layout and sidebar partials.</p>
                </div>
                <span class="inline-flex rounded-full bg-sky-50 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-sky-500 dark:bg-sky-500/15 dark:text-sky-300">Overview</span>
            </div>

            <div class="grid gap-4 xl:grid-cols-[minmax(0,1.6fr)_minmax(280px,0.8fr)]">
                <div class="relative overflow-hidden rounded-[24px] border border-sky-100 bg-gradient-to-b from-white to-cyan-50 px-4 pb-8 pt-6 dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
                    ...
                    <div class="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-cyan-100/70 to-transparent dark:bg-none"></div>
                    ...
                    <div class="relative h-64">
                        ...
                        <div class="absolute inset-x-0 -bottom-1 flex justify-between px-1 text-xs text-slate-400 dark:text-slate-500">
                            <span>Jan</span>
                            <span>Feb</span>
                            <span>Mar</span>
                            <span>Apr</span>
                ...
                <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
                    <div class="rounded-[24px] border border-white/60 bg-white/85 p-5 shadow-[0_16px_32px_rgba(121,154,198,0.10)] dark:border-slate-700/60 dark:bg-slate-900/80">
                        <p class="text-sm font-semibold text-slate-700 dark:text-slate-200">Total Students</p>
                        <p class="mt-3 text-4xl font-semibold text-slate-800 dark:text-slate-100">{{ $studentCount }}</p>
                        <p class="mt-2 text-sm text-slate-400 dark:text-slate-400">Current records in the system</p>
                    </div>

                    <div class="rounded-[24px] border border-white/60 bg-white/85 p-5 shadow-[0_16px_32px_rgba(121,154,198,0.10)] dark:border-slate-700/60 dark:bg-slate-900/80">
                        <div class="mb-4 flex items-center justify-between">
                            <p class="text-sm font-semibold text-slate-700 dark:text-slate-200">Email Split</p>
                            <span class="text-xs text-slate-400 dark:text-slate-500">Snapshot</span>
                        </div>

                        <div class="space-y-4">
                            <div>
                                <div class="mb-2 flex items-center justify-between text-xs text-slate-400 dark:text-slate-500">
                                    <span>Gmail</span>
